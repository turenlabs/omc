...
![OMC in action — npm and pip packages install with no host access and no install scripts; then a risky one is X-rayed and blocked with the credential-exfiltration reason before it ever runs](docs/demo.gif)
