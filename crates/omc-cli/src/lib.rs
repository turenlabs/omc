...
pub(crate) mod npm_global_cli;
pub(crate) mod npm_list_cli;
...
pub(crate) use npm_global_cli::{
    normalize_npm_global_args, npm_global_bin_dir_from_prefix, npm_global_location_flag_value,
    npm_global_prefix_path, npm_global_project_dir_from_prefix, sync_npm_global_bins,
};

pub(crate) use npm_list_cli::{
    npm_cyclonedx_sbom, npm_dependency_name, npm_help_flag, npm_help_search_ignored_equals_flag,
    npm_help_search_text, npm_help_text, npm_list_all_flag_value, npm_list_ignored_equals_flag,
...
pub(crate) fn remove_cli_path_if_exists(path: &Path) -> Result<(), OmcRegistryError> {
...
pub(crate) fn npm_outdated_dependent(project_dir: &Path) -> String {
...
pub(crate) fn package_list_filter_names(
    filters: &[String],
    ecosystem: Option<Ecosystem>,
) -> Result<BTreeSet<String>, OmcRegistryError> {
    filters
...
pub(crate) fn npm_all_workspaces_flag_value(arg: &str) -> Option<bool> {
    match arg {
...
pub(crate) fn npm_attached_short_value(arg: &str, flag: char) -> Option<&str> {
    if arg.starts_with("--") {
        return None;
    }
...
pub(crate) fn ignored_npm_install_preference_flag(arg: &str) -> bool {
    matches!(
        arg,
        "--ignore-scripts"
            | "--ignore-scripts=true"
...
pub(crate) fn ignored_npm_install_preference_equals_flag(arg: &str) -> bool {
    [
        "--ignore-scripts=",
        "--foreground-scripts=",
        "--fund=",
