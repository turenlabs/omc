...
use uv_lock::{
    collect_uv_dist_hash, uv_dependency_requirement, uv_local_sources, PythonDependencyRequirement,
    UvLock, UvProject,
};

pub(crate) mod pipfile;

pub(crate) mod python_parse;
pub(crate) use python_parse::*;
...
#[cfg(test)]
pub(crate) use project_discovery::{
    read_package_json_requirements, read_package_json_specs, read_package_lock_requirements,
};
...
pub(crate) fn extend_project_requirements(
...
pub(crate) fn collect_package_json_local_dependency_paths(
...
pub(crate) fn read_pylock_requirements(path: &Path) -> Result<ProjectRequirements> {
...
pub(crate) fn constrained_pypi_requirement(
    spec: &PackageSpec,
    constraints: &BTreeMap<String, String>,
) -> Option<String> {
